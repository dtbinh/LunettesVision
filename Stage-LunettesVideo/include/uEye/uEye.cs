...
public class uEye
{
    ...
    public const int IS_SENSOR_UI1240LE_M = 0x54;       // SXGA global shutter, monochrome, single board
    public const int IS_SENSOR_UI1240LE_C = 0x55;       // SXGA global shutter, color, single board
    ...
    public const int IS_SENSOR_UI1580_M = 0x5A;         // 5MP rolling shutter, monochrome
    public const int IS_SENSOR_UI1580_C = 0x5B;         // 5MP rolling shutter, color
    public const int IS_SENSOR_UI1580LE_M = 0x60;       // 5MP rolling shutter, monochrome, single board
    public const int IS_SENSOR_UI1580LE_C = 0x61;       // 5MP rolling shutter, color, single board
    ...
    public const int IS_SENSOR_UI241X_M_R2 = 0x0182;    // Sony CCD sensor - VGA monochrome
    public const int IS_SENSOR_UI251X_M    = 0x0182;    // Sony CCD sensor - VGA monochrome
    public const int IS_SENSOR_UI241X_C_R2 = 0x0183;    // Sony CCD sensor - VGA color
    public const int IS_SENSOR_UI251X_C    = 0x0183;    // Sony CCD sensor - VGA color

    public const int IS_SENSOR_UI2130_M = 0x019E;        // Sony CCD sensor - WXGA monochrome
    public const int IS_SENSOR_UI2130_C = 0x019F;        // Sony CCD sensor - WXGA color
    ...
    public const int IS_I2C_0_BIT_REGISTER  = 0x20000000;
    ...
    public const int IS_HOTPIXEL_SAVE_SOFTWARE_USER_LIST_UNICODE     = 0x8111;
    public const int IS_HOTPIXEL_LOAD_SOFTWARE_USER_LIST_UNICODE     = 0x8112;
    ...
    public const int IS_SET_DM_OPENGL = 0x8;
    ...
    public const int DR_GET_OVERLAY_DATA = 28;
    public const int DR_UPDATE_OVERLAY_DATA = 29;
    public const int DR_GET_SUPPORTED = 30;
    ...
    public const int IS_INTERFACE_TYPE_USB3 = 0x60;
    ...
    public const int IS_BOARD_TYPE_UEYE_USB_ML = (IS_INTERFACE_TYPE_USB + 5);   // 0x45

    public const int IS_BOARD_TYPE_UEYE_USB3_CP = (IS_INTERFACE_TYPE_USB3 + 4); // 0x64 
    ...
    public const int IS_BOARD_TYPE_UEYE_ETH_LE = (IS_INTERFACE_TYPE_ETH + 2);   // 0x82
    ...
    public const int IS_CAMERA_TYPE_UEYE_USB_ML = IS_BOARD_TYPE_UEYE_USB_ML;

    public const int IS_CAMERA_TYPE_UEYE_USB3_CP = IS_BOARD_TYPE_UEYE_USB3_CP;
    ...
    public const int IS_CAMERA_TYPE_UEYE_ETH_LE = IS_BOARD_TYPE_UEYE_ETH_LE;
    ...
    public const int IS_OS_WIN8 = 13;
    ...
    public const int IS_USB_SUPER_SPEED = 4000;
    ...
    public unsafe struct UEYE_CAPTURE_STATUS_INFO
    {
        public uint u64CapStatusCnt_Total;
        public fixed byte Reserved[60];
        public fixed uint CapStatusCnt_Detail[256]; // access via UEYE_CAPTURE_STATUS
    }
    ...
    unsafe public struct IS_DEVICE_INFO_HEARTBEAT
    {
        public fixed byte reserved_1[24];
        public int        dwRuntimeFirmwareVersion;
        public fixed byte reserved_2[8];
        public short      wTemperature;
        public short      wLinkSpeed_Mb;
        public fixed byte reserved_3[6];
        public short      wComportOffset;
        public fixed byte reserved[200];
    }


    unsafe public struct IS_DEVICE_INFO_CONTROL
    {
    ...
    unsafe public struct IS_DEVICE_INFO
    {
    ...
    public const int IS_DEVICE_INFO_CMD_GET_DEVICE_INFO = 0x02010001;
    

    // is_DeviceInfo
    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_DeviceInfo")]
    private static extern int is_DeviceInfo(int hCam, uint nCommand, IntPtr pParam, uint nSizeOfParam);
    ...
    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_ReadI2C")]		// is_ReadI2C
    ...
    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_SetTriggerCounter")]	// is_SetTriggerCounter
    private static extern int is_SetTriggerCounter(int hCam, int nValue);
    ...
    public struct OPENGL_DISPLAY
    {
        public int nWindowID;
        public IntPtr pDisplay;
    };
    ...
    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_SetSaturation")] // is_SetSaturation
    private static extern int is_SetSaturation(int hCam, int ChromU, int ChromV);
    ...
    public const uint IS_DEVICE_FEATURE_CMD_GET_LOG_MODE_DEFAULT                = 11;
    public const uint IS_DEVICE_FEATURE_CMD_GET_LOG_MODE                        = 12;
    public const uint IS_DEVICE_FEATURE_CMD_SET_LOG_MODE                        = 13;
    public const uint IS_DEVICE_FEATURE_CMD_GET_LOG_MODE_MANUAL_VALUE_DEFAULT   = 14;
    public const uint IS_DEVICE_FEATURE_CMD_GET_LOG_MODE_MANUAL_VALUE_RANGE     = 15;
    public const uint IS_DEVICE_FEATURE_CMD_GET_LOG_MODE_MANUAL_VALUE           = 16;
    public const uint IS_DEVICE_FEATURE_CMD_SET_LOG_MODE_MANUAL_VALUE           = 17;
    public const uint IS_DEVICE_FEATURE_CMD_GET_LOG_MODE_MANUAL_GAIN_DEFAULT    = 18;
    public const uint IS_DEVICE_FEATURE_CMD_GET_LOG_MODE_MANUAL_GAIN_RANGE      = 19;
    public const uint IS_DEVICE_FEATURE_CMD_GET_LOG_MODE_MANUAL_GAIN            = 20;
    public const uint IS_DEVICE_FEATURE_CMD_SET_LOG_MODE_MANUAL_GAIN            = 21;
    ...
    public const uint IS_DEVICE_FEATURE_CAP_LOG_MODE                                = 0x00000020;
    public const uint IS_DEVICE_FEATURE_CAP_SHUTTER_MODE_ROLLING_GLOBAL_START       = 0x00000040;
    public const uint IS_DEVICE_FEATURE_CAP_SHUTTER_MODE_GLOBAL_ALTERNATIVE_TIMING  = 0x00000080;

    // Log modes
    public const uint IS_LOG_MODE_FACTORY_DEFAULT   = 0;
    public const uint IS_LOG_MODE_OFF               = 1;
    public const uint IS_LOG_MODE_MANUAL            = 2;
    ...
    public const uint IPCONFIG_CMD_SET_AUTOCONFIG_IP_BYDEVICE   = 0x01040100;
    public const uint IPCONFIG_CMD_GET_PERSISTENT_IP            = 0x02010000;
    public const uint IPCONFIG_CMD_GET_AUTOCONFIG_IP            = 0x02040000;
    public const uint IPCONFIG_CMD_GET_AUTOCONFIG_IP_BYDEVICE   = 0x02040100;
    ...
    */
    unsafe public struct IO_GPIO_CONFIGURATION
    {
        public uint u32Gpio;
        public uint u32Caps;
        public uint u32Configuration;
        public uint u32State;
        public fixed uint u32Reserved[12];
    };
    ...
    */
    ...
    public const uint IS_GPIO_INPUT                     = 0x0001;
    public const uint IS_GPIO_OUTPUT                    = 0x0002;
    public const uint IS_GPIO_FLASH                     = 0x0004;
    public const uint IS_GPIO_PWM                       = 0x0008;
    public const uint IS_GPIO_COMPORT_RX                = 0x0010;
    public const uint IS_GPIO_COMPORT_TX                = 0x0020;
    ...
    public const uint IS_IO_CMD_GPIOS_GET_CONFIGURATION           = 29;
    public const uint IS_IO_CMD_GPIOS_SET_CONFIGURATION           = 30;
    ...
    /*!
    * \brief Defines used by is_AutoParameter()
    */
    public const uint IS_AWB_CMD_GET_SUPPORTED_TYPES              = 1;
    public const uint IS_AWB_CMD_GET_TYPE                         = 2;
    public const uint IS_AWB_CMD_SET_TYPE                         = 3;
    public const uint IS_AWB_CMD_GET_ENABLE                       = 4;
    public const uint IS_AWB_CMD_SET_ENABLE                       = 5;
    public const uint IS_AWB_CMD_GET_SUPPORTED_RGB_COLOR_MODELS   = 6;
    public const uint IS_AWB_CMD_GET_RGB_COLOR_MODEL              = 7;
    public const uint IS_AWB_CMD_SET_RGB_COLOR_MODEL              = 8;

    public const uint IS_AWB_GREYWORLD                            = 0x0001;
    public const uint IS_AWB_COLOR_TEMPERATURE                    = 0x0002;

    public const uint IS_AUTOPARAMETER_DISABLE                    = 0;
    public const uint IS_AUTOPARAMETER_ENABLE                     = 1;
    public const uint IS_AUTOPARAMETER_ENABLE_RUNONCE             = 2;

    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_AutoParameter")]
    private static extern int is_AutoParameter(int hCam, uint nCommand, IntPtr pParam, uint nSizeOfParam);


    /*!
    * \brief Defines used by is_Convert()
    */
    unsafe public struct BUFFER_CONVERSION_PARAMS
    {
        public IntPtr pSourceBuffer;
        public IntPtr pDestBuffer;
        public int nDestPixelFormat;
        public int nDestPixelConverter;
        public int nDestGamma;
        public int nDestEdgeEnhancement;
        public int nDestColorCorrectionMode;
        public int nDestSaturationU;
        public int nDestSaturationV;
        public fixed byte reserved[32];
    }

    public const uint IS_CONVERT_CMD_APPLY_PARAMS_AND_CONVERT_BUFFER = 1;

    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_Convert")]
    private static extern int is_Convert(int hCam, uint nCommand, IntPtr pParam, uint nSizeOfParam);


    /*!
    * \brief Defines used by is_ParameterSet()
    */
    public const uint IS_PARAMETERSET_CMD_LOAD_EEPROM           = 1;
    public const uint IS_PARAMETERSET_CMD_LOAD_FILE             = 2;
    public const uint IS_PARAMETERSET_CMD_SAVE_EEPROM           = 3;
    public const uint IS_PARAMETERSET_CMD_SAVE_FILE             = 4;
    public const uint IS_PARAMETERSET_CMD_GET_NUMBER_SUPPORTED  = 5;

    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_ParameterSet")]
    private static extern int is_ParameterSet(int hCam, uint nCommand, IntPtr pParam, uint nSizeOfParam);


    /*!
    * \brief Defines used by is_EdgeEnhancement()
    */
    public const uint IS_EDGE_ENHANCEMENT_CMD_GET_RANGE             = 1;
    public const uint IS_EDGE_ENHANCEMENT_CMD_GET_DEFAULT           = 2;
    public const uint IS_EDGE_ENHANCEMENT_CMD_GET                   = 3;
    public const uint IS_EDGE_ENHANCEMENT_CMD_SET                   = 4;

    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_EdgeEnhancement")]
    private static extern int is_EdgeEnhancement(int hCam, uint nCommand, IntPtr pParam, uint nSizeOfParam);


    /*!
    * \brief Defines used by is_PixelClock()
    */
    ...
    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_PixelClock")]
    private static extern int is_PixelClock(int hCam, uint nCommand, IntPtr pParam, uint nSizeOfParam);
    

    /*!
    *\brief Data type for 32-bit signed int value ranges.
    */
    public struct IS_RANGE_S32
    {
        public int s32Min;
        public int s32Max;
        public int s32Inc;
    ...
    /*!
    * \brief Defines used by is_Blacklevel()
    */
    public const int IS_AUTO_BLACKLEVEL_OFF                 = 0;
    public const int IS_AUTO_BLACKLEVEL_ON                  = 1;

    public const int IS_BLACKLEVEL_CAP_SET_AUTO_BLACKLEVEL  = 1;
    public const int IS_BLACKLEVEL_CAP_SET_OFFSET           = 2;

    public const int IS_BLACKLEVEL_CMD_GET_CAPS             = 1;
    public const int IS_BLACKLEVEL_CMD_GET_MODE_DEFAULT     = 2;
    public const int IS_BLACKLEVEL_CMD_GET_MODE             = 3;
    public const int IS_BLACKLEVEL_CMD_SET_MODE             = 4;
    public const int IS_BLACKLEVEL_CMD_GET_OFFSET_DEFAULT   = 5;
    public const int IS_BLACKLEVEL_CMD_GET_OFFSET_RANGE     = 6;
    public const int IS_BLACKLEVEL_CMD_GET_OFFSET           = 7;
    public const int IS_BLACKLEVEL_CMD_SET_OFFSET           = 8;

    [DllImport(DRIVER_DLL_NAME, CallingConvention = CallingConvention.Cdecl, EntryPoint = "is_Blacklevel")]
    private static extern int is_Blacklevel(int hCam, uint nCommand, IntPtr pParam, uint nSizeOfParam);
    ...
    private string GetStringFromByte(byte[] pByte, int nStart, int nLength)
    {
        ...
        for (i = 0; i < nLength; i++)
        {
            pChars[i] = System.Convert.ToChar(pByte[nStart + i]);
        }
    ...
    public int GetSensorInfo(ref SENSORINFO pSensorInfo)
    {
        ...
        if (ret == IS_SUCCESS)
        {
            ...
            pSensorInfo.bMasterGain = System.Convert.ToBoolean(pTemp[44]);
            pSensorInfo.bRGain = System.Convert.ToBoolean(pTemp[48]);
            pSensorInfo.bGGain = System.Convert.ToBoolean(pTemp[52]);
            pSensorInfo.bBGain = System.Convert.ToBoolean(pTemp[56]);
            pSensorInfo.bGlobShutter = System.Convert.ToBoolean(pTemp[60]);
            pSensorInfo.wPixelSize = System.Convert.ToUInt16((pTemp[65] << 8) + pTemp[64]);
        }
    ...
    public int GetEthDeviceInfo(int iDeviceID, ref UEYE_ETH_DEVICE_INFO pDeviceInfo)
    {
        ...
        if (ret == IS_SUCCESS)
        {
            ...
            off += 6;
            off += 2;
            pDeviceInfo.infoAdapter.bIsEnabledDHCP = System.Convert.ToBoolean(pTemp[off]);
            off += 4;
            ...
            off += 4;
            off += 4;
            pDeviceInfo.infoAdapter.bIsValidAutoCfgIpRange = System.Convert.ToBoolean(pTemp[off]);
            off += 4;
    ...
    public int DeviceInfo(uint nCommand, IntPtr pParam, uint nSizeOfParam)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_DeviceInfo(m_hCam, nCommand, pParam, nSizeOfParam);
    }
    ...
    // -------------------  AutoParameter -----------------------
    //
    public int AutoParameter(uint nCommand, IntPtr pParam, uint SizeOfParam)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_AutoParameter(m_hCam, nCommand, pParam, SizeOfParam);
    }

    // -------------------  Convert -----------------------
    //
    public int Convert(uint nCommand, IntPtr pParam, uint SizeOfParam)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_Convert(m_hCam, nCommand, pParam, SizeOfParam);
    }

    // -------------------  Parameters -----------------------
    //
    public int ParameterSet(uint nCommand, IntPtr pParam, uint SizeOfParam)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_ParameterSet(m_hCam, nCommand, pParam, SizeOfParam);
    }

    // -------------------  EdgeEnhancement -----------------------
    //
    public int EdgeEnhancement(uint nCommand, IntPtr pParam, uint SizeOfParam)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_EdgeEnhancement(m_hCam, nCommand, pParam, SizeOfParam);
    }

    // -------------------  PixelClock -----------------------
    //
    public int PixelClock(uint nCommand, IntPtr pParam, uint SizeOfParam)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_PixelClock(m_hCam, nCommand, pParam, SizeOfParam);
    }

    // -------------------  GetVsyncCount -----------------------
    //
    public int GetVsyncCount(ref long pIntr, ref long pActIntr)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_GetVsyncCount(m_hCam, ref pIntr, ref pActIntr);
    }

    // -------------------  GetAutoInfo -----------------------
    //
    public int GetAutoInfo(ref byte[] pInfo)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_GetAutoInfo(m_hCam, pInfo);
    }

    // -------------------  WriteI2C -----------------------
    //
    public int WriteI2C(int s32DeviceAddr, int s32RegisterAddr, byte[] pData, int s32Length)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_WriteI2C(m_hCam, s32DeviceAddr, s32RegisterAddr, pData, s32Length);
    }

    // -------------------  ReadI2C -----------------------
    //
    public int ReadI2C(int s32DeviceAddr, int s32RegisterAddr, ref byte[] pData, int s32Length)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_ReadI2C(m_hCam, s32DeviceAddr, s32RegisterAddr, pData, s32Length);
    }

    // -------------------  SetCameraID -----------------------
    //
    public int SetCameraID(int s32ID)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_SetCameraID(m_hCam, s32ID);
    }
    ...
    public int ResetToDefault()
    {
        ...
        return is_ResetToDefault(m_hCam);
    }

    // -------------------  SetSaturation -----------------------
    //
    public int SetSaturation(int ChromU, int ChromV)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_SetSaturation(m_hCam, ChromU, ChromV);
    }

    // -------------------  SetTriggerCounter ----------------------
    //
    public int SetTriggerCounter(int nValue)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_SetTriggerCounter(m_hCam, nValue);
    }

    // -------------------  Blacklevel ----------------------
    //
    public int Blacklevel(uint nCommand, IntPtr pParam, uint SizeOfParam)
    {
        if (m_hCam == 0)
            return IS_INVALID_CAMERA_HANDLE;

        return is_Blacklevel(m_hCam, nCommand, pParam, SizeOfParam);
    }
}
